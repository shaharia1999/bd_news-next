...
const PoliticBengali = () => {
    return (
        ...
        </p><p className="text-3xl font-bold">Bangladesh</p>
       </div>
       <div className="grid lg:grid-cols-10 md:grid-cols-12 grid-cols-1 gap-5">
       <div className=" lg:col-span-4 md:col-span-12 ">
            ...
            <div className=" lg:col-span-2 md:col-span-4 grid grid-cols-1 gap-3 ... ">
