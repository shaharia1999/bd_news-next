...
const MagazineBreaking = () => {
    return (
        <div>
            <div className="flex">
        <div className="Magazine">
            <div>
        <Image src={ronaldo} alt="sports" className="w-full h-[500px]"  />
        </div>
        </div> 
        <div className="w-[50%]">
    ...
    </p><p className="text-3xl font-bold">All</p>
   </div>
    ...
    <div className=" lg:col-span-4 md:col-span-4 ">
        ...
        <div className="flex gap-4">
           <div><Image src={sports} alt="sports" className="w-32 h-20" /></div>
           <div className='lg:leading-6 2xl:leading-5'> <a href='#' className=" lg:font-bold font-bold  text-[12px] lg:text-[16px] ">
       Unprecedented Colorado ruling puts courts at the center of Trump’s fate next year
       </a></div>
        </div>
        <div className="flex gap-4">
...
export default MagazineBreaking;